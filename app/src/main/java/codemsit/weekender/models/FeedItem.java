package codemsit.weekender.models;
...
public class FeedItem {
    ...
    public String getDisc_amt() {return disc_amt;}
    public void setDisc_amt(String disc_amt) {this.disc_amt = disc_amt;}
    ...
    public String getSliderstring() {return SliderString;}
    public void setSliderstring(String SliderString) {this.SliderString = SliderString;}
    ...
    public String getItemscost() {return itemscost;}
    public void setItemscost(String itemscost) {this.itemscost = itemscost;}
    ...
    public void setFoodCost(String foodcost) {this.foodcost = foodcost;}

    public String getTimings() {return timings;}
    public void setTimings(String timings) {this.timings = timings;}

    public String getCustomerBillId() {return CustomerBillId;}
    public void setCustomerBillId(String CustomerBillId) {this.CustomerBillId = CustomerBillId;}
